...
__device__ __forceinline__ unsigned get_current_delta()
{
	unsigned delta_info = delta_info_local;
	return bfg_get_delta(delta_info);
}

__device__ __forceinline__ unsigned get_current_shifted()
{
	unsigned delta_info = delta_info_local;
	return bfg_get_dist(delta_info);
}
